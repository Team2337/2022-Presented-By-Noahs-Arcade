...
public class RobotContainer {
  ...
  public void configureButtonBindingsTeleop() {
    ...
    intakeBeamBreakTrigger.whenInactive(new TriggerCommandGroup(shooter::isShooterToSpeed, driverController, delivery).andThen(new WaitCommand(0.3)).andThen(new PerpetualConditionalBloopShoot(redLeftSwitch::get, climber, delivery, kicker, shooter).andThen(new StopAllShooterSystemsCommand(delivery, kicker, shooter))));
