 ...
 * @author Nicholas S
 */
public class MoveToMidRung extends CommandBase {
  ...
  public MoveToMidRung(XboxController controller, Climber climber) {
  ...
  public boolean isFinished() {
    return (climber.getEncoderPosition() >= climber.stringpotToEncoder(climber.MID_RUNG));
  }
}