 ...
 */
public class ProfiledPointToPointWithHeadingCommand extends HeadingToTargetCommand implements AutoDrivableCommand {
  ...
  public ProfiledPointToPointWithHeadingCommand(PolarCoordinate target, Supplier<Translation2d> translationSupplier, double headingAngle, double driveP, double strafeP, double forwardAcceleration, double strafeAcceleration, AutoDrive autoDrive, Heading heading) {
    super(
  ...
  public void initialize() {
    ...
    heading.autonMaintainHeading(true, headingAngle);
  ...
  public void end(boolean interrupted) {
    ...
    heading.autonMaintainHeading(false, headingAngle);
