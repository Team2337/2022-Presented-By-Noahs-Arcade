...
public class OdometryHeadingCommand extends CommandBase {
  ...
  */
  ...
  public void execute() {
    Pose2d pose = drivetrain.getPose();
    PolarCoordinate polarCoordinate = PolarCoordinate.fromFieldCoordinate(
      pose.getTranslation(),
      point
    );
    // The angle is the angle outward from our center point. In order to face 
    // our center point, we need to rotate our angle by 180 degrees.
    heading.setMaintainHeading(polarCoordinate.getTheta().unaryMinus());
  }
