 ...
 *
 */
public class ForwardKickerDistanceCommand extends CommandBase {
   ...
   */
  public ForwardKickerDistanceCommand(Supplier<Translation2d> translationSupplier, Kicker kicker) {
    this.kicker = kicker;
  ...
  public void execute() {
    ...
    if (distance < 45 || (distance > 120 && distance < 145)) {
      kicker.start(0.5);
      isFinishedCounter++;
    }
